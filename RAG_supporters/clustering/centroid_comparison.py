"""
Centroid comparison utilities - DEPRECATED.

This module is deprecated. Centroid comparison functionality has been integrated
into the KeywordClusterer class in keyword_clustering.py for better cohesion.

For new code, use KeywordClusterer methods directly:
- KeywordClusterer.compute_distances()
- KeywordClusterer.find_nearest_cluster()
- KeywordClusterer.get_all_distances()
- KeywordClusterer.compare_keyword()
- KeywordClusterer.compare_text()

The CentroidComparator class is maintained here for backward compatibility only.
It now wraps KeywordClusterer functionality.

TODO: In a future major version, remove this module entirely and update all
references to use KeywordClusterer directly.
"""
...
class CentroidComparator:
    """
    DEPRECATED: Use KeywordClusterer instead.

    This class is maintained for backward compatibility. It wraps KeywordClusterer
    functionality for centroid comparison operations.
    """
    ...
    def __init__(
        ...
        DEPRECATED: Consider using KeywordClusterer.from_results() instead.
        ...
        """
        LOGGER.warning(
            "CentroidComparator is deprecated. Use KeywordClusterer instead."
        )
    ...
    def from_clustering_results(
        ...
        DEPRECATED: Use KeywordClusterer.from_results() instead.
        ...
        """
        LOGGER.warning(
            "CentroidComparator.from_clustering_results() is deprecated. "
            "Use KeywordClusterer.from_results() instead."
        )
