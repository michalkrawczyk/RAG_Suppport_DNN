...
from RAG_supporters.dataset.steering_embedding_generator import SteeringEmbeddingGenerator
...
class DomainAssessmentDatasetBuilder:
    ...
    def build(self) -> None:
        ...
        self._save_embeddings('steering', np.array(steering_embeddings, dtype=np.float32))
        ...
        self.storage.set_dataset_info('label_normalizer', self.label_calculator.normalizer)
