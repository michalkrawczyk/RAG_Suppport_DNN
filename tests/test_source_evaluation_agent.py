...
class TestSourceEvaluationAgentProcessDataFrame:
    ...
    def test_process_dataframe_basic(self):
        ...
        result_df = agent.process_dataframe(
            df, question_col="question_text", source_col="source_text"
        )
    ...
    def test_process_dataframe_with_include_reasoning(self):
        ...
        df = pd.DataFrame(
            {"question_text": ["What is photosynthesis?"], "source_text": ["Photosynthesis is..."]}
        )

        result_df = agent.process_dataframe(
            df, question_col="question_text", source_col="source_text", include_reasoning=True
        )
    ...
    def test_process_dataframe_skip_existing(self):
        ...
        result_df = agent.process_dataframe(
            df, question_col="question_text", source_col="source_text", skip_existing=True
        )
