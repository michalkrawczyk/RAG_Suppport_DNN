...
See [agent_architecture.md](../coding_guidelines/agent_architecture.md) and [agent_workflow.md](../coding_guidelines/agent_workflow.md).
...
| [coding_guidelines/agent_architecture.md](agents_notes/coding_guidelines/agent_architecture.md) | Writing or reviewing agent imports or LangChain abstractions |
