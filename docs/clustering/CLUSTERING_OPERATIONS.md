...
- [Data Preparation](../data_preparation/DATA_PREPARATION.md) - CSV merger for getting pairs
- [JASPER Builder](../jasper_builder/JASPER_BUILDER.md) - Complete pipeline
- [Contrastive Learning](../contrastive_learning/CONTRASTIVE_LEARNING.md) - Uses cluster assignments for negatives
